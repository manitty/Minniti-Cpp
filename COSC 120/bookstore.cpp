...
int bookstore[12][6];
int monthTotal(int[MONTH][nbook], int);
void monthHigh(int[MONTH][nbook], int);
void monthLow(int[MONTH][nbook], int);
void bookTotal(int[MONTH][nbook], int&, int&, int&, int&, int&, int&);
void bookHigh(int[MONTH][nbook]);
void bookLow(int[MONTH][nbook]);
int bookSales(int[MONTH][nbook], int);
